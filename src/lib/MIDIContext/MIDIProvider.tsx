...
export function MIDIProvider(props: { children: React.ReactNode; onError: (err: Error) => void }): JSX.Element {
  ...
  const sendMIDICC = useCallback(
    ...
    [connectedMIDIOutputs, sendMIDIMessage, experimental_isRecording, recordMessage, setMIDIValue],
  )
  ...
  const value = useMemo(
    (): MIDIContextValue => ({
      ...
      experimental_savedRecordings,
      experimental_isRecording,
      experimental_startRecording,
    }),
    [
      midiInputs,
      midiOutputs,
